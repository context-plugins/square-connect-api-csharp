...
public record RetrieveCatalogObjectResponse
{
    /// <summary>
    ...
    public CatalogObject? Object { get; init; }

    /// <summary>
    /// A list of <c>CatalogObject</c>s referenced by the object in the <c>object</c> field.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
