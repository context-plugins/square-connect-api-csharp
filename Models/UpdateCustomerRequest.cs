...
public record UpdateCustomerRequest
{
    ...
    /// <para>
    /// As a best practice, you should include this field to enable <see href="https://developer.squareup.com/docs/working-with-apis/optimistic-concurrency">optimistic concurrency</see> control. For more information, see <see href="https://developer.squareup.com/docs/customers-api/use-the-api/keep-records#update-a-customer-profile">Update a customer profile</see>.
    /// </para>
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
